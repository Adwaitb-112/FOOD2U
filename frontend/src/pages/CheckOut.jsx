...
function CheckOut() {
    ...
    const getAddressByLatLng = async (lat, lng) => {
        try {
            const res = await axios.get(`https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${lng}&format=json&apiKey=${apiKey}`)
            ...
            <div className='w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6'>
                ...
                <section>
                    <h2 className='text-lg font-semibold mb-2 flex items-center gap-2 text-gray-800'>
                        <FaMapLocationDot className='text-[#ff4d2d]' />Delivery Location</h2>
