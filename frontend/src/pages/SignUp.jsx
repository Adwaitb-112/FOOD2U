...
function SignUp() {
    ...
    const handleGoogleAuth = async () => {
        if (!mobile) {
            return setErr("Mobile is required")
        }
    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4' style={{
            ...
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-1px `} style={{
                ...
                <h1 className={`text-3xl font-bold mb-2 `} style={{ color: primaryColor }}>Food2U</h1>
                ...
                <div className='mb-4'>
                    ...
                    <input type="mobile" className='w-full border rounded-lg px-3 py-2 focus:outline-none ' placeholder='Enter your mobile' style={{ border: `1px solid ${borderColor}` }} onChange={(e) => setMobile(e.target.value)} value={mobile} required />
                </div>
                ...
                <div className='mb-4'>
                    ...
                    <div className='relative'>
                        ...
                        <button className='absolute right-3 top-[10px] cursor-pointer text-gray-500' onClick={() => setShowPassword(prev => !prev)}>{!showPassword ? <GiEvilEyes className='text-2xl' /> : <GiAngryEyes className='text-2xl' />}</button>
                    </div>
                </div>
                ...
                <button className='w-full cursor-pointer mt-4 flex items-center justify-center gap-2 border rounded-lg px-4 py-2 transition duration-200 border-gray-400 hover:bg-gray-100' onClick={handleGoogleAuth}>
                    <FcGoogle size={20} />
